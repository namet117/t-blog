...
export const otherRouter = {
    ...
    children: [
        ...
        // 文章详情页面
        { path: 'article/:article_id', title: '文章详情', name: 'article-info', component: resolve => { require(['@/views/article/article-info.vue'], resolve); } },
        // 新增文章页面
        { path: 'article-create', title: '新增文章', name: 'article-create', component: resolve => { require(['@/views/article/article-create.vue'], resolve); } },
    ]
};
...
export const appRouter = [
    ...
    //     component: Main,
    //     children: [
    //         { path: 'article-publish', title: '文章发布', name: 'article-publish', icon: 'compose', component: resolve => { require(['@/views/form/article-publish/article-publish.vue'], resolve); } },
    ...
    // },
    {
        ...
        component: Main,
        children: [
            { path: 'list', title: '文章列表', name: 'article-list', icon: 'ios-list', component: resolve => { require(['@/views/article/article-list.vue'], resolve); } },
            { path: 'tag', title: '标签列表', name: 'tag-list', icon: 'bookmark', component: resolve => { require(['@/views/article/tag-list.vue'], resolve); } }
        ]
    },
    {
        path: '/message-board',
        ...
        component: Main,
        children: [
            { path: 'list', title: '留言列表', name: 'message-board-list', icon: 'ios-list', component: resolve => { require(['@/views/message-board/message-board-list.vue'], resolve); } }
        ]
    },
    // {
    //     path: '/error-page',
